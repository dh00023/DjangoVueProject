...
class ItemAdmin(admin.ModelAdmin):
	...
	list_display = 	('itemCode', 'itemName', 'price',  'imageUrl', 'get_lookbook', 'get_styleshare')
...
class StyleShareAdmin(admin.ModelAdmin):
	list_display = ('user', 'get_items', 'image','created_at') # 모델의 object
	list_filter = ['created_at'] # 필터기능
	exclude = ['user',]
